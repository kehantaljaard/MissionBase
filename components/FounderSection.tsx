...
export default function FounderSection({ content }: Props) {
  return (
    <section id="founder" className="py-12 md:py-20 bg-amber-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col-reverse md:flex-row gap-6 md:gap-10 items-start">
          ...
          <div className="w-full md:w-2/3">
            <h3 className="text-xl md:text-2xl font-semibold text-amber-700 mb-3 md:mb-4">{content.name}</h3>
          ...
          <div className="w-full md:w-1/3 flex-shrink-0">
            {content.image ? (
              ...
              <div className="w-full aspect-[3/4] bg-amber-100 rounded-xl flex items-center justify-center border-2 border-dashed border-amber-300">
