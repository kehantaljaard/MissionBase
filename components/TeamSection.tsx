...
export default function TeamSection({ content }: Props) {
  ...
  return (
    <section id="team" className="py-12 md:py-20 bg-blue-800">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-start">
          ...
          <div className="w-full md:w-1/3 flex-shrink-0">
            {content.image ? (
              ...
              <div className="w-full aspect-[3/4] bg-blue-700/50 rounded-xl flex items-center justify-center border-2 border-dashed border-blue-400/40">
          ...
          {/* Description */}
          <div className="w-full md:w-2/3 text-blue-100 leading-relaxed text-sm md:text-base">
